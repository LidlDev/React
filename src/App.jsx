...
function App() {
  ...
  const projects = [
    { id: 1, title: 'Spike! Volleyball App', description: 'Interactive app for volleyball teams, communication, and training.', imageUrl: '/path/to/spike-app.jpg', tags: ['Flutter', 'Firebase', 'Mobile'] },
